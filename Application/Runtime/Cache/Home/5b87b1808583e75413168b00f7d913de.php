...
<body>
	...
	<div class="panel" style="border: 0;">
  		<div class="panel-heading">
  			<div class="pull-left">产品展示</div>
  			<div class="pull-right">您现在的位置：首页&gt;&gt;产品展示</div>
  			<div class="clearfix"></div>
  		</div>
  		<div class="panel-body">
  			<ul class="list-group">

  			  <?php if(is_array($productArr)): $i = 0; $__LIST__ = $productArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$productlist): $mod = ($i % 2 );++$i;?><li class="list-group-item">
				<h4><a href="/index.php/home/product/productlist/id/<?php echo ($productlist['id']); ?>" style="color:#333;font-weight: bold;"><?php echo ($productlist['title']); ?></a></h4>
				<p style="color:#999;">发布时间:<?php echo (mb_substr($productlist['pubtime'],0,10,'utf-8')); ?> &nbsp;&nbsp;  点击次数：2566</p>
				<div>
					<p style="color:#666;"><?php echo (mb_substr($productlist['content'],0,150,'utf-8')); ?></p>
