...
<body>
	...
	<div class="panel" style="border: 0;">
  		<div class="panel-heading">
  			...
  			<div class="pull-right">您现在的位置：首页&gt;&gt;动态新闻</div>
  			<div class="clearfix"></div>
  		</div>
  		<div class="panel-body">
  			<ul class="list-group">

  			  <?php if(is_array($newsArr)): $i = 0; $__LIST__ = $newsArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newslist): $mod = ($i % 2 );++$i;?><li class="list-group-item">
				<h4><a href="/index.php/home/news/newslist/id/<?php echo ($newslist['id']); ?>" style="color:#333;font-weight: bold;"><?php echo ($newslist['title']); ?></a></h4>
				<div>
					<p style="color:#666;"><?php echo (mb_substr($newslist['content'],0,100,'utf-8')); ?></p>
					<p style="color:#999;">发布时间:<?php echo (mb_substr($newslist['pubtime'],0,10,'utf-8')); ?> &nbsp;&nbsp;  点击次数：134</p>
				</div>
