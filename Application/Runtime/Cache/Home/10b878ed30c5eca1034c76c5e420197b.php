...
<body>
	...
	<div class="panel" style="border: 0;">
  		<div class="panel-heading">
  			<div class="pull-left">招商加盟</div>
  			<div class="pull-right">您现在的位置：首页&gt;&gt;招商加盟</div>
  			<div class="clearfix"></div>
  		</div>
  		<div class="panel-body">
  	
		    <form action="/index.php/home/about/joinus" method="post">
		      <div class="form-group">
		        <label for="name">联系人</label>
		        <input type="text" class="form-control"  required placeholder="联系人" name="username">
		      </div>
		      <div class="form-group">
		        <label for="alterEgo">电话</label>
		        <input type="text" class="form-control" id="alexa" placeholder="电话" name="tel">
		      </div>
		       <div class="form-group">
		        <label for="alterEgo">留言内容</label>
		        <textarea name="content" id="" cols="30" rows="10" placeholder="请在这里留言" class="form-control"></textarea>
		      </div>
	...
	<div class="container footer" style="text-align: center;background:#018044;color:#fff;padding:10px 10px 0 10px">
		<p><a href="/">网站首页</a> | <a href="/index.php/Home/About/about/id/1">关于我们</a> | <a href="/index.php/home/product/product">产品中心</a> | <a href="/index.php/home/news/news">新闻中心</a> | <a href="/index.php/home/about/joinus">在线留言</a>&nbsp;|&nbsp;<a href="/index.php/home/about/touch">联系我们</a>&nbsp;| <a href="/region/" target="_self">企业分站</a>&nbsp;| <a href="http://si.trustutn.org/info?sn=192161026025108249020&amp;certType=1" target="_self"><img src="/application/Public/Home/images/renzheng.png" title="1477874494877589.png" alt="bottom_large_img.png"></a></p>
	</div>
