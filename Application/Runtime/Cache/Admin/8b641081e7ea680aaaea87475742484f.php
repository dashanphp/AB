			...
			<div class="right col-md-9 pull-left">
				<div class="panel">
					...
					<div class="panel panel-body">
						...
						<form action="/index.php/admin/product/add" class="frm" method="post" name="content" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['id']); ?>"><?php echo ($list['typename']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>	
								</select>
							</div>
							<div class="form-group">
