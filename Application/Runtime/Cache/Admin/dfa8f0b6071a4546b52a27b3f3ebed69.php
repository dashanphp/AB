			...
			<div class="right col-md-9 pull-left">
				<div class="panel">
					...
					<div class="panel panel-body">
						...
						<form action="/index.php/admin/company/update" class="frm" method="post" name="content" enctype="multipart/form-data">

							<div class="form-group">
								<label for="">新闻标题:</label>
								<input type="text" name="title" id="" class="form-control" value="<?php echo ($new['title']); ?>">
							</div>
							
							<div class="form-group">
								<label for="">新闻内容:</label>
								<textarea  name="content" id="content" class="form-control"><?php echo ($new['content']); ?></textarea>
							</div>
