			...
			<div class="right col-md-9 pull-left">
				<div class="panel">
					...
					<div class="panel panel-body">
						...
						<form action="/index.php/admin/news/update" class="frm" method="post" name="content" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="">作者:</label>
								<input type="text" name="author" id="" class="form-control" value='<?php echo ($new[0]['author']); ?>'>
							</div>
