				...
				<div class="panel">
					...
					<div class="panel panel-body">
						<table class="table table-striped">
								...
								<?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$companylist): $mod = ($i % 2 );++$i;?><tr>
							    	
							    	<td><?php echo ($companylist['title']); ?></td>
							    	<td><?php echo ($companylist['pubtime']); ?></td>
							    	<td><a href="updatefm/id/<?php echo ($companylist['id']); ?>" class="btn btn-primary btn-sm" style="color:#fff;">修改</a></td>
							    	<td><a href="delete/id/<?php echo ($companylist['id']); ?>" class="btn btn-danger btn-sm" style="color:#fff;">删除</a></td>
